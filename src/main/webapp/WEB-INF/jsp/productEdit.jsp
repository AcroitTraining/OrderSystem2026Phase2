...
<head>
    <meta charset="UTF-8">
    <title><%= ((ProductEditInfo)request.getAttribute("productEditInfo")).getProductId() == 0 ? "商品作成" : "商品変更" %></title>
...
<div class="home-container">
    ...
    <div class="page-title"><%= isNew ? "新規商品作成" : "商品変更" %></div> 
        ...
        <form action="ProductEditServlet" method="post">
            ...
            <div class="form-group">
                ...
                <select name="categoryName">
                    <option value="" <%= isNew || info.getCategoryName() == null || info.getCategoryName().isEmpty() ? "selected" : "" %>>-選択してください-</option>
            ...
            <div class="form-group">
                ...
                <input type="text" name="productName" class="input-product-name" value="<%= info.getProductName() %>" placeholder="例: 納豆お込み焼き">
            </div>
            ...
            <div class="form-group">
                ...
                <input type="number" name="productPrice" class="input-price" value="<%= isNew ? "" : info.getProductPrice() %>" placeholder="0">
