...
<title>注文変更</title>
<link rel="stylesheet"
	href="${pageContext.request.contextPath}/css/editOrder.css">
</head>
<body>
	...
	<div class="order-box">
		...
		<form action="EditOrderServlet" method="post" id="editOrderForm">
			...
			<input type="hidden" name="mode" id="submitMode" value=""> <input
				type="hidden" name="oldProductQty"
				value="<%= info.getProductQuantity() %>"> <input
				type="hidden" name="from" value="<%= from %>">

			<div class="main-product-row">
				<span class="product-name"><%= info.getProductName() %></span>
				<div class="quantity-counter">
					<button type="submit" name="Button" value="main_minus"
						class="btn-minus">−</button>
					<span class="qty-num"><%= info.getProductQuantity() %></span>
					<button type="submit" name="Button" value="main_plus"
						class="btn-plus">+</button>
				</div>
				<button type="button" class="btn-cancel-order" id="triggerDelete">注文取り消し</button>
			</div>
			...
			<div class="toppings-container">
				...
				<div class="topping-cell">
					...
					<div class="quantity-counter">
						<input type="hidden" name="oldQty_<%= i %>"
							value="<%= topping.getQuantity() %>">
	...
	<div id="deleteModal" class="modal-overlay">
		<div class="modal-content">
			<p class="modal-message-title">この注文を削除します</p>
			<p class="modal-message-sub">よろしいですか？</p>
			<div class="modal-buttons">
				<button type="button" id="deleteNo" class="btn-modal-no">いいえ</button>
				<button type="button" id="deleteYes" class="btn-modal-yes-red">はい</button>
			</div>
		</div>
	</div>
	<% } %>
