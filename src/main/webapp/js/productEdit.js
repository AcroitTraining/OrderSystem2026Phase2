document.addEventListener("DOMContentLoaded", function () {
    ...
    var productStockInput = document.querySelector("input[name='productStock']");
    ...
    function checkNameDuplicate() {
        ...
        var url =
            "ProductEditServlet?action=checkDuplicate"
            + "&productName="
    ...
    form.addEventListener(
        ...
        function (e) {
            ...
            if (!productNameInput.value.trim()) {
                ...
                productNameInput.value.length > 18
            ) {
