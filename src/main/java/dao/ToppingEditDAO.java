...
public class ToppingEditDAO {
    // トッピング詳細の取得
    public ToppingEditInfo findToppingDetails(Connection conn, int toppingId) throws SQLException {
    ...
    // 新規登録処理（各フラグを一律1にする）
    public void insertToppingDetails(Connection conn, String toppingName, int toppingPrice) throws SQLException {
    ...
    // 更新処理
    public void updateToppingDetails(Connection conn, int toppingId, String toppingName, int toppingPrice) throws SQLException {
